class Api::V1::FornecedoresController < ApplicationController
    ...
    def index
      fornecedores = Fornecedor.where(informacao_loja_id: @current_user.informacao_loja)
    ...
    def set_fornecedor
      @fornecedor = Fornecedor.find_by(id: params[:id], informacao_loja_id: @current_user.informacao_loja)
